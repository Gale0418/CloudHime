...
class TranslationSettingsPanel(QFrame):
    ...
    def set_translate_advanced_visible(self, visible):
        ...
        self.adjustSize()
        QTimer.singleShot(0, self._lock_column_hint)

    def _lock_column_hint(self):
        # Keep the card geometry stable after toggling the advanced area.
        self.updateGeometry()
    ...
    def update_theme(self, theme_mode):
        ...
        self.lbl_translate_mode.setStyleSheet(f"color: {theme.text};")
